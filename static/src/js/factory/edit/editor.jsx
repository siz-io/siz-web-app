...
var ReactSlider = require('../../vendor-patched/react-slider');
    ...
    <div className="editor">
      ...
      <div className="gifs">
        <div className="gif gif1">
          <a className={'btn ' + this.getGifSelectorClass(gif0)} href="#">
            1</a>{(gif0.get('endMs') > 0) &&
        ...
        <div className="gif gif2">
          <a className={'btn ' + this.getGifSelectorClass(gif1)} href="#">
            2</a>{(gif1.get('endMs') > 0) &&
        ...
        <div className="gif gif3">
          <a className={'btn ' + this.getGifSelectorClass(gif2)} href="#">
            3</a>{(gif2.get('endMs') > 0) &&
        ...
        <div className="gif gif4">
          <a className={'btn ' + this.getGifSelectorClass(gif3)} href="#">
            4</a>{(gif3.get('endMs') > 0) &&
        ...
        <div className="substrip" ref="substripArea">
          <div className="substrip-content">
            <a className="btn valid create-btn" href="#" onClick={this.onClickCreateStrip}>
              Create strip</a>
      ...
      <div className={'scissors-indicator ' + (this.getGifIndicator(gifs) ? '' : 'hidden')}>
        <img src="/static/img/scissors.png"/>
        <span>
          {this.getGifIndicator(gifs)}</span>
      </div>
      <div className="gif-preview">
        <div className="tutorial">
          <p>
            1. Navigate in the video</p>
          <p>
            2. Click on a number to capture a highlight</p>
          <p>
            3. Adjust it with the tool below</p>
        </div>
        { activeGif &&
